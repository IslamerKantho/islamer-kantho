...
import { getAllPostsWithSlug, getPostAndMorePosts } from '../../pages/api/api'
import Head from 'next/head'
import { CMS_NAME } from '../../pages/api/constants'
      ...
      <Container>
        {router.isFallback ? (
          ...
          <>
            <Head>
              <title>
                {post.title} | ইসলামের কন্ঠ
              </title>

              <meta property="og:title" content={post.title} />
              <meta property="og:site_name" content="ইসলামের কন্ঠ" />
              <meta property="og:url" content={`https://islamerkantho.com/article/${post.slug}`} />
              <meta property="og:description" content={post.excerpt} />
              <meta property="og:type" content="article" />
              <meta property="og:image" content={imageBuilder(post.coverImage).url()} />
