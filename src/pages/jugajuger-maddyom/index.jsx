    ...
    <Layout>
      ...
      <section className="py-8 md:py-11">
        <div className="container max-w-[800px] text-justify space-y-4">
          <h6 className="text-lg font-bold text-[#055547]">পরিচিতি</h6>
          <p>
          ...
          <p>
            ...
            <br />
            ফোরাম-{" "}
            <a href="http://www.forum.islamerkantho.com" className="text-[#055547] underline">
              http://www.forum.islamerkantho.com
            </a>
            <br />
            ই-মেইল-{" "}
            <a href="mailto:info@islamerkantho.com" className="text-[#055547] underline">
