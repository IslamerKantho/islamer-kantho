  ...
  return (
    <Layout>
      ...
      <section className="py-8 md:py-11">
        <div className="container max-w-[800px] text-justify space-y-4">
          <h6 className="text-lg font-bold text-[#055547]">লেখা পাঠানোর নিয়মাবলী</h6>
          <p>
          ...
          <h6 className="text-lg font-bold text-[#055547]">নিয়মাবলী:</h6>
          ...
          <p>
            ...
            <a
              ...
              className="text-[#055547] underline"
            >
              https://www.facebook.com/islamerkantho
            </a>
            <br />
            ওয়েবসাইটঃ{" "}
            <a href="https://islamerkantho.com/" title="ইসলামের কন্ঠ" className="text-[#055547] underline">
              https://islamerkantho.com/
            </a>
            <br />
            ই-মেইলঃ{" "}
            <a href="mailto:info@islamerkantho.com" title="ইসলামের কন্ঠ" className="text-[#055547] underline">
              info@islamerkantho.com
            </a>
            <br />
            <a href="https://islamerkantho.com/editorial" title="সম্পাদকীয়" className="text-[#055547] underline">
