      ...
      <div className="w-full flex flex-col sm:flex-row gap-4">
        ...
        <div className="w-full sm:w-[calc(100%-330px)]">
          <div className="mt-1 flex items-center flex-row gap-2">
            ...
            <span className="pl-2 border-l border-gray-300 text-[#6b6b6b] text-[11px] font-bold leading-4">
          ...
          <p className="mt-2.5 mb-0 text-[#6b6b6b] text-[13px] leading-[160%] [line-break:anywhere]">
